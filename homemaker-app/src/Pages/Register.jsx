  ...
  return (
    <div>
      <div className="container">
        <div className="row ">
          <form
            className="col-lg-6 col-sm-12 input-login p-5"
          ...
          >
            ...
            <div className="email--input ">
              ...
              <input
                value={work}
                onChange={(e) => workchange(e.target.value)}
                type="text"
              ...
              <div className="dropdown">
                ...
                <ul className="dropdown-menu  drop-menu" aria-labelledby="dropdownMenuLink">
                  <li>
            ...
            <button type="submit" className="input--btn-1-r mt-5">
              Confirm
            </button>
          </form>

          <div className=" col-lg-6 col-sm-12 input-side-img-r">
